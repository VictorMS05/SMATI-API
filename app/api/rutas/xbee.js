...
router.get('/niveles_recientes/', xbeeRouter.consultarNivelesRecientes); // Se define la ruta para obtener un registro reciente de los dispositivos Xbee y se llama al método correspondiente
